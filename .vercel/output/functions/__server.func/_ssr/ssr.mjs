...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BpBTpQIW.mjs");
...
var manifest = {
	"6b22755f49a0228903d7a64f2d03c6a9fde48244706c018b768ecb599be09ccc": {
		functionName: "createDonation_createServerFn_handler",
		importer: () => import("./donations-BQJZ6rnb.mjs")
	},
	"a8921e413081ebf94e456addcbec78f6ac2050cc544e73baf968a33c6327dc0d": {
		functionName: "listDonations_createServerFn_handler",
		importer: () => import("./donations-BQJZ6rnb.mjs")
	},
	"d073e5de66e751c8c23d0e184a9e860a97becc79575929878ae77f9f2574238b": {
		functionName: "getCampaignSummary_createServerFn_handler",
		importer: () => import("./donations-BQJZ6rnb.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B3NJ4Lv3.mjs").then((n) => n.t),
